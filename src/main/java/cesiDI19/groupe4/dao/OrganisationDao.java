...
String sql = "SELECT ID_ORGANISATION as ID, ID_CIVIL, NOM_ORGANISATION, ADRESSE_ORGANISATION, COMMENTAIRE_ORGANISATION" +
		"DATE_AJOUT_ORGANISATION, DATE_DERNIERE_MODIFICATION_ORGANISATION FROM ORGANISATION where ID_ORGANISATION=?";
